<x-layouts.admin.admin-layout>
    ...
    <div class="p-6 bg-white w-full rounded-t-md flex items-center justify-between border-b border-gray-200">
        <h1 class="font-semibold text-lg">Data Transaksi Product</h1>
        ...
        <tbody>
            @for ($i = 0; $i < 10; $i++)
                <tr class="border-b border-gray-200">
                    ...
                    <td class=" w-full py-4  flex items-center justify-center gap-2">
                        <a href="{{ url('#') }}"
                        ...
                        <a href="{{ url('#') }}"
                            class="bg-orange-100 flex items-center justify-center w-8 h-8 rounded-md hover:bg-secondaryColors-20">
                            <x-icons.truck-shipping class="size-5 stroke-orange-600 "></x-icons.truck-shipping>
                        </a>
                        <a href="{{ url('#') }}"
                            class="bg-red-100 flex items-center justify-center w-8 h-8 rounded-md hover:bg-secondaryColors-20">
                            <x-icons.delete-01 class="size-5 stroke-red-600 "></x-icons.delete-01>
                        </a>
                    </td>
                </tr>
            @endfor
