            ...
            <div class="flex flex-col">
                ...
                <div class="w-full bg-light-base rounded-b-lg border border-gray-200 p-5">
                    ...
                    <label for="description">
                        ...
                        <textarea
                            id="description"
                            class="mt-0.5 w-full h-[220pt] rounded"
                        ></textarea>
                    </label>
                </div>
            </div>
                ...
                <div class="w-full bg-light-base rounded-b-lg border border-gray-200 p-5">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <label for="time_start_event">
                            ...
                            <input type="time" name="time_start_event" id="time_start_event" class="mt-0.5 w-full h-[25pt] rounded">
                        </label>
                        <label for="time_end_event">
                            <span class="text-sm font-medium text-gray-700"> Waktu Akhir Event </span>

                            <input type="time" name="time_end_event" id="time_end_event" class="mt-0.5 w-full h-[25pt] rounded">
                        </label>
                    </div>
                    <label for="location">
                ...
                <div class="w-full bg-light-base rounded-b-lg border border-gray-200 p-5">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <label for="price_event">
                            ...
                            <input type="number" name="price_event" id="price_event" class="mt-0.5 w-full h-[25pt] rounded">
                        </label>
                        <label for="quota_event">
                            <span class="text-sm font-medium text-gray-700"> Kuota Event </span>

                            <input type="number" name="quota_event" id="quota_event" class="mt-0.5 w-full h-[25pt] rounded">
                        </label>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-span-full">
                        <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                            ...
                            <div class="mt-4 flex text-sm/6 text-gray-600">
                                <label for="file-upload" class="relative cursor-pointer rounded-md bg-white font-semibold text-secondaryColors-base focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 focus-within:outline-hidden hover:text-secondaryColors-60">
