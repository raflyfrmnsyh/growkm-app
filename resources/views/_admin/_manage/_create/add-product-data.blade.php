        ...
        <div class="w-full bg-white rounded-lg shadow p-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <div>
                    ...
                    <p class="text-base text-gray-500">Tambahkan produk baru ke toko Anda</p>
                </div>
                <div class="text-xs text-gray-400">
                    Dashboard / Kelola Produk / <span class="text-secondaryColors-base font-semibold">Tambah
                        Produk</span>
                </div>
            </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="w-full flex items-start justify-between gap-6">
                    <div class="product_informations w-[48%]">
                        ...
                        <div x-data="{
                            ...
                            <label for="product_image"
                                ...
                                <div class="flex flex-col items-center justify-center pt-5 pb-6" x-show="!preview">
                                    ...
                                    <p class="mb-2 text-md text-gray-500"><span class="font-semibold">Click to
                                            upload</span> gambar produk</p>
                        ...
                        <div class="mb-4 flex flex-col w-full">
                            <label for="product_desc" class="font-medium text-gray-800 w-full">Deskripsi Produk</label>
                            <textarea name="product_desc" id="descField" rows="3" placeholder="Deskripsi produk"
                                ...
                                <div class="flex flex-wrap gap-2 px-3 py-3 border border-gray-200 rounded-md">
                                    <template x-for="tag in tags" :key="tag">
                                        <div
                                            ...
                                            <input type="hidden" name="product_category[]" :value="tag">
                                        </div>
                                    </template>
