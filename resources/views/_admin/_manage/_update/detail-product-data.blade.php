<x-layouts.admin.admin-layout>
    ...
    <div class="p-6 bg-white w-full">
        ...
        <form action="{{ route('admin.manage.product.update', $product->product_id) }}" method="POST"
            enctype="multipart/form-data" class="flex gap-2 flex-wrap justify-between items-start">
            @csrf
            @method('PUT')
                    ...
                    <div class="mb-4 flex flex-col w-full">
                        ...
                        <div class="flex gap-2">
                            <input type="number" min="1" name="product_min_order" id="minOrderField"
                                value="{{ old('product_min_order', $product->product_min_order) }}" required
