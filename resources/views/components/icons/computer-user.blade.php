<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="" fill="none"
    ...
    <path
        ...
        stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
    <path
        d="M12 10.5C13.1046 10.5 14 9.60457 14 8.5C14 7.39543 13.1046 6.5 12 6.5C10.8954 6.5 10 7.39543 10 8.5C10 9.60457 10.8954 10.5 12 10.5ZM12 10.5C10.3431 10.5 9 11.8431 9 13.5M12 10.5C13.6569 10.5 15 11.8431 15 13.5"
        stroke="" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
</svg>
