<x-layouts.auth>
    ...
    <div class="flex flex-col gap-8 w-full">
        ...
        <form action="{{ route('auth.login.process') }}" method="POST" id="loginForm" class="flex flex-col gap-3.5" x-data="{ email: '', password: '', showPassword: false }">
            @csrf
            <!-- Email Input -->
                ...
                @if($errors->has('email'))
                    <p class="text-red-500 text-sm mt-1 flex items-center gap-1">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8 5.33334V8M8 10.6667H8.00667M14.6667 8C14.6667 11.6819 11.6819 14.6667 8 14.6667C4.3181 14.6667 1.33334 11.6819 1.33334 8C1.33334 4.3181 4.3181 1.33334 8 1.33334C11.6819 1.33334 14.6667 4.3181 14.6667 8Z" stroke="#EF4444" stroke-width="1.5" stroke-linecap="round"/>
                        </svg>
                        {{ $errors->first('email') }}
                    </p>
                @endif
            ...
            <div class="flex flex-col gap-4 mt-4">
                <button type="submit" class="jakarta flex justify-center items-center py-[14px] px-[24px] bg-[#003C43] text-white rounded-[8px] font-semibold text-[16px] leading-[20px] w-full">
                    Sign In
                </button>
                ...
                <div class="flex justify-center items-center gap-2">
                    ...
                    <a href="" class="urbanist font-medium text-[18px] leading-[22px] text-[#072326] font-semibold underline">
                        Sign Up
                    </a>
                </div>
