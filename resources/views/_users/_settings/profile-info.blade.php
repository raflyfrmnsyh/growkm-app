...
>>>>>>> cd4426a38ea803d9a1ce14f30d8474fc61e774bc
...
<<<<<<< HEAD
        ...
        <div class="w-full bg-white rounded-lg shadow p-8">
            ...
            <div class="flex border-b mb-8">
                <a href="{{ route('profile.info') }}" class="px-4 py-2 border-b-2 border-[#007F73] text-[#007F73] font-semibold">Profile Info</a>
            ...
            <form>
                <div class="flex items-center gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <button type="button" class="px-4 py-2 border rounded text-sm" onclick="document.getElementById('fileInput').click();">
                            Unggah Foto
                        </button>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" class="w-full border rounded px-4 py-2 text-sm" placeholder="Enter your name">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full border rounded px-4 py-2 text-sm" placeholder="Enter your birthplace">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" class="w-full border rounded px-4 py-2 text-sm" placeholder="Masukan Kabupaten/Kota">
                    </div>
                </div>
                <div class="mb-6">
                ...
                <div class="w-full bg-white rounded-lg shadow p-8">
                    ...
                    <div class="flex border-b mb-8">
                        <a href="{{ route('profile.info') }}"
                            class="px-4 py-2 border-b-2 border-[#007F73] text-[#007F73] font-semibold">Profile Info</a>
                        <a href="{{ route('account.info') }}" class="px-4 py-2 text-gray-600">Akun Info</a>
                        <a href="{{ route('change.password') }}" class="px-4 py-2 text-gray-600">Ubah Password</a>
                    </div>
                    ...
                    <form>
                        <div class="flex items-center gap-6 mb-8">
                            ...
                            <div>
                                <p class="text-sm mb-2">Upload foto baru dengan ukuran kurang dari 1 MB, dan bertipe JPG
                                    atau PNG.</p>
