                ...
                <div class="w-full  bg-white rounded-lg shadow p-8">
                    ...
                    <div class="flex border-b mb-8">
                        ...
                        <a href="{{ route('change.password') }}"
                            class="px-4 py-2 border-b-2 border-[#007F73] text-[#007F73] font-semibold">Ubah Password</a>
                    </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                <input id="old_password" type="password"
                                    class="w-full border rounded px-4 py-2 text-sm pr-10" placeholder="xxxxxxxx">
                                <button type="button" onclick="togglePassword('old_password', this)"
                                    class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500">
                                    <svg id="icon_old_password" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePassword('new_password', this)"
                                    class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500">
                                    <svg id="icon_new_password" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="togglePassword('confirm_password', this)"
                                    class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-500">
                                    <svg id="icon_confirm_password" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5"
                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
