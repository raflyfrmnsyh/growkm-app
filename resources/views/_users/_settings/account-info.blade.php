...
<<<<<<< HEAD
        ...
        <div class="w-full max-w-6xl bg-white rounded-lg shadow p-8">
            ...
            <div class="flex border-b mb-8">
                ...
                <a href="{{ route('account.info') }}" class="px-4 py-2 border-b-2 border-[#007F73] text-[#007F73] font-semibold">Akun Info</a>
            ...
            <form>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                        ...
                        <input type="text" class="w-full border rounded px-4 py-2 text-sm" placeholder="Example@gmail.com">
                    </div>
                    <div>
                        <label class="block text-sm font-medium mb-1">Nomor HP</label>
                        <input type="text" class="w-full border rounded px-4 py-2 text-sm" placeholder="08XX XXXX XXXX">
                    </div>
                </div>
