            ...
            <div class="flex flex-col items-center bg-gray-100 min-h-screen py-2 w-full">
                <div class="w-full max-w-6xl bg-white rounded-lg shadow p-8">
                    ...
                    <div class="flex border-b mb-8">
                        <a href="{{ route('course.all') }}" class="px-4 py-2 text-gray-600">Semua Kelas & Event</a>
                        <a href="{{ route('course.just.course') }}" class="px-4 py-2 text-gray-600">Kelas sedang diikuti</a>
                        <a href="{{ route('course.just.event') }}" class="px-4 py-2 text-gray-600">Event sedang diikuti</a>
                        <a href="{{ route('course.all.done') }}" class="px-4 py-2 border-b-2 border-secondaryColors-base text-secondaryColors-base font-semibold">Sudah selesai</a>
                    </div>
                            ...
                            <div class="m-5">
                                <div class="flex items-start gap-4">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <p class="text-xs text-dark">Course by <span class="font-bold text-secondaryColors-base">EduGrow</span></p>
